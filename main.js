...
let pattern = /love/gi; // g specifies to search everywhere, i to be case-insensitive
...
let pattern3 = /[%$@&#]/g; // a way to specify a pattern with a bunch of symbols
...
let pattern4 = /\d+/g; // d specifies to match digits, + one or more digits, g to search everywhere
